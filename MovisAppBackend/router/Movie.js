...
const fileds = uploadSetting.upload.fields([
  {
    name: 'image',
    maxCount: 1
  }
...
router.post('/insert', fileds, (req, res) => {
  const imageName = uploadSetting.cekNull(req.files['imege'])
...
router.put('/edit/:id', fileds,(req, res) => {
